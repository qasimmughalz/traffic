...
export const AddNewTrafficSite = ({ traffic = true }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      inputWebsite === '' ||
      inputWebsite.includes('/') ||
      inputWebsite.includes('http')
    ) {
      if (inputWebsite === '') {
        setanyError(true);
            ...
            <div className='container-fluid'>
              <div className='row align-items-start'>
                      ...
                      <div className='row '>
                        <form onSubmit={handleSubmit} className='w-100'>
                          <div className='form-group my-3 '>
                            <label> Please Select Feature</label>
                            <select
                          ...
                          <div className='form-group my-3 '>
                            ...
                            {inputError ? (
                              <p className='text-danger mt-1'>
                                {' '}
                                {`Please add 'www' before Domain Name !`}
                              </p>
                            ) : null}
                          </div>
                  ...
                  <div className='col-md-8 m-auto'>
                    <div className='d-sm-flex align-items-center justify-content-between mb-4'>
                      <div>
                        <h1 className='h3 mb-0 text-gray-800'>
                          Code for{' '}
                          <span className='font-weight-light p-1  text-blue'>
                            {inputWebsite}
                          </span>{' '}
                          is here.
                        </h1>
                    ...
                    <p className='my-3 text-center'>
                      ...
                      script will not work untill you process the payment.
                    </p>
                    <div className='col-md-4 m-auto my-3 text-center '>
                      <Link to='/paymentplans'>
                        <button
                          className='btn btn-form btn-primary my-4'
                          value='submit'
                          type='submit'
                          style={{ width: '100%' }}
                        >
                ...
                <div className='col-md-4 text-center mt-5'>
                  <p className='my-3'>
                    {inputWebsite === '' ? 'www.example.com' : inputWebsite}
                  </p>
